...
class PlaceMarkerBodyState extends State<PlaceMarkerBody> {
  ...
  static final LatLng center = const LatLng(49.286439, -123.143411);
  ...
  void _add() {
    ...
    final Marker marker = Marker(
      markerId: markerId,
      position: LatLng(
        center.latitude + sin(_markerIdCounter * pi / 6.0) / 60.0,
        center.longitude + cos(_markerIdCounter * pi / 6.0) / 60.0,
      ),
          ...
          child: SizedBox(
            ...
            child: GoogleMap(
              ...
              initialCameraPosition: const CameraPosition(
                target: LatLng(49.224911, -123.124077),
                zoom: 10.0,
              ),
